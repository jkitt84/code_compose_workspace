 ...
 * NEED TO PULL P1.3 up to Vcc with a 10kOhm resistor!!!!!!!!!
 */
//------------------------------------------------------------
...
#define BUT1 BIT3//button 1 which is p1.3
//------------------------------------------------------------
void main(void)
{
	WDTCTL = WDTPW | WDTHOLD;
	P1OUT = 0x00;//pre-load everything off
	P1DIR = LED1;//set LED1 as an output
...
__interrupt void PORT1_ISR (void)//this is the name that can be changed
{
