...
//jpk... this was supposed be deleted //#pragma vector=TIMER0_A0_VECTOR // MSP430G2452, MSP430G2553             //!!!
...
__interrupt void TimerA0_ISR(void) {                                      //!!!
	...
	//
	if (counter == 1e6/10000){ // If the value of counter == 100
		P1OUT ^= 0xFF;         // Toggle the state of all pins on port 1
